...
const Login = () => {
    ...
    return (
        <div className="h-screen flex justify-center items-center bg-bg-color">
            <div className="w-1/2 rounded-md bg-box-color flex justify-between flex-col">
                ...
                <div className="h-20 mx-auto">
                    <span className="text-sm text-gray-600">Dont have an account?  
                        <Link href={REGISTER_ROUTE}><span className="text-black-btn font-semibold text-md" > Register Here</span></Link>
                    </span>
                </div>
            </div>
        </div>
